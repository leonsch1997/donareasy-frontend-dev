...
export const endpoints = {
  ...
  aceptarTransferencia: (id: string) => `${baseURL}/donaciones/transferenciasPendientes/${id}/aceptar/`,
  rechazarTransferencia: (id: string) => `${baseURL}/donaciones/transferenciasPendientes/${id}/rechazar/`
}
